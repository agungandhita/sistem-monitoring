...
<body class="bg-gradient-to-br from-green-50 to-emerald-100 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full mx-4">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Login Dashboard Wali Siswa</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}"
                            class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-green-500 focus:border-green-500 @error('email') border-red-500 @enderror"
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="password" name="password"
                            class="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-green-500 focus:border-green-500 @error('password') border-red-500 @enderror"
            ...
            <div class="text-center">
                <div class="text-sm text-gray-600">
                    <a href="{{ route('guru.login') }}" class="text-blue-600 hover:text-blue-500">Login sebagai Guru</a>
                    <span class="mx-2">|</span>
                    <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-500">Login sebagai Admin</a>
                </div>
            </div>
        </div>
    </div>
