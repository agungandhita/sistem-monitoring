...
@section('title', 'Catatan Perkembangan - Wali')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4 sm:py-6">
                <div>
                    ...
                    <p class="text-sm sm:text-base text-gray-600">Lihat catatan perkembangan anak Anda</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="p-4 sm:p-6">
                            ...
                            <div class="flex justify-center">
                                <a href="{{ route('wali.catatan-perkembangan.show', $siswa->siswa_id) }}" 
                                   class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200 w-full justify-center">
