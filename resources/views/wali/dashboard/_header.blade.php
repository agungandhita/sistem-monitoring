<div class="fixed w-full top-0 left-0 px-4 border-b-[1px] border-main3 bg-main z-20 ">
    <div class="h-20 relative md:ml-64">
        <div class="absolute top-[50%] -translate-y-[50%] w-full overflow-hidden bg-main">
            <div class="flex flex-row  justify-between">
                <div class="flex gap-x-2">
                    ...
                    <h1 class="font-semibold text-Sidebar my-auto text-xl text-white">Laporan Perkembangan</h1>
                </div>
