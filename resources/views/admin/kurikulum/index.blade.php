                ...
                <tr class="hover:bg-gray-50 kurikulum-row" data-nama="{{ strtolower($kurikulum->nama_kurikulum) }}" data-tahun="{{ strtolower($kurikulum->tahun_ajaran) }}">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            ...
                            <button onclick="confirmDelete({{ $kurikulum->kurikulum_id }}, '{{ $kurikulum->nama_kurikulum }}')" 
...
<script>
    ...
    function confirmDelete(id, name) {
        ...
        document.getElementById('deleteForm').action = `{{ route('admin.kurikulum.destroy', '') }}/${id}`;
