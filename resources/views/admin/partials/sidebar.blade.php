                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{route('admin.dashboard')}}"
                            class="text-gray-700 text-sm flex items-center hover:bg-gray-50 rounded-md px-4 py-2.5 transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-500' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.kurikulum.index') }}"
                            class="text-gray-700 text-sm flex items-center hover:bg-gray-50 rounded-md px-4 py-2.5 transition-all {{ request()->routeIs('admin.kurikulum.*') ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] mr-3">
                    ...
                    <li>
                        <a href="{{ route('admin.mapel.index') }}"
                            class="text-gray-700 text-sm flex items-center hover:bg-gray-50 rounded-md px-4 py-2.5 transition-all {{ request()->routeIs('admin.mapel.*') ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] mr-3">
                    ...
                    <li>
                        <a href="{{ route('admin.kelas.index') }}"
                            class="text-gray-700 text-sm flex items-center hover:bg-gray-50 rounded-md px-4 py-2.5 transition-all {{ request()->routeIs('admin.kelas.*') ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] mr-3">
                    ...
                    <li>
                        <a href="{{ route('admin.guru.index') }}"
                            class="text-gray-700 text-sm flex items-center hover:bg-gray-50 rounded-md px-4 py-2.5 transition-all {{ request()->routeIs('admin.guru.*') ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] mr-3">
                    ...
                    <!-- === TAHAP 2: ASSIGNMENT & MAPPING === -->
                    
                    <!-- 6. GURU MAPEL -->
                    <li>
                        <a href="{{ route('admin.guru-mapel.index') }}"
                            class="text-gray-700 text-sm flex items-center hover:bg-gray-50 rounded-md px-4 py-2.5 transition-all {{ request()->routeIs('admin.guru-mapel.*') ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] mr-3">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('admin.siswa.index') }}"
                            class="text-gray-700 text-sm flex items-center hover:bg-gray-50 rounded-md px-4 py-2.5 transition-all {{ request()->routeIs('admin.siswa.*') ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] mr-3">
                    ...
                    <li>
                        <a href="{{ route('admin.jadwal.index') }}"
                            class="text-gray-700 text-sm flex items-center hover:bg-gray-50 rounded-md px-4 py-2.5 transition-all {{ request()->routeIs('admin.jadwal.*') ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] mr-3">
                    ...
                    <li>
                        <a href="{{ route('admin.nilai-harian.index') }}"
                            class="text-gray-700 text-sm flex items-center hover:bg-gray-50 rounded-md px-4 py-2.5 transition-all {{ request()->routeIs('admin.nilai-harian.*') ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] mr-3">
